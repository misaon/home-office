...
| `@clack/prompts`                     | 1.8.0                       | 2026-09-07                           | 20.4 M                  | **ADD** (Wave 6) — replaces the `stty -echo` hand-rolled hidden prompt in `apps/cli/src/commands/secret.ts`.                                                                                                              |
...
| `commander`                          | 15.0.0                      | 2026-09-02                           | 451.1 M                 | **candidate, see ADR 003** — 0 deps, generates `--help`, would delete the hand-maintained `USAGE` string.                                                                                                                 |
| `citty`                              | 0.2.2                       | 2026-08-20                           | 27.5 M                  | **candidate, see ADR 003** — unjs, 0 deps, TypeScript-first, but pre-1.0.                                                                                                                                                 |
| `cac`                                | 7.0.0                       | 2026-02-27                           | 44.0 M                  | rejected in ADR 003 — 6 months quiet and no advantage over `commander`.                                                                                                                                                   |
