...
| B5  | CLI environment                  | ROZHODNUTO | all 22 `apps/cli` files                                                                         | B5.1–B5.4, **B5.5**              | B5.5 done in Wave 3; B5.1–B5.4 → Wave 6                                                            |
| B6  | UI environment                   | ROZHODNUTO | all 40 `packages/ui` files                                                                      | B6.1–B6.5, **B6.6**              | B6.1, B6.2, B6.4, B6.6 done; B6.3, B6.5 → Wave 6                                                   |
...
| B21 | Lower RAM/CPU                    | ROZHODNUTO | `sim/**`, `daemon/**`, `images/agent/Dockerfile`                                                | B21.1, B21.2, B10.2, B4.2        | B21.1, B10.2, B4.2 done; B21.2 (the runner's second Bun) → Wave 5                                  |
