...
- Status: **Phases 0–3 complete**: the boss triages chat messages and delegates over MCP tools, workers and reviewers run in sandboxes with a review loop, handoffs, human questions and resumed conversations; branches or pull requests are delivered to local and git-URL projects. Next: Phase 4 (office simulation and UI). See the Log in docs/PLAN.md.
