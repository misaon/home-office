...
const ACCEPTANCE =
  "Done for the whole request: when you delegate more than one task, or a task whose criteria do not cover everything the human asked for, put the conditions of done for the whole request in ho_report's acceptance, each one observable on the combined result. Once every task is done the office integrates the branches and has someone who wrote none of it verify those conditions; a failure reopens the work for a bounded number of rounds, and only a pass closes the request.";
