...
const INSTRUCTIONS: Readonly<Record<SessionMode, string>> = {
  ...
  triage:
    "Home Office tools for the boss. ho_plan hands a request to the analyst, who specifies and splits it; ho_delegate creates one task per independently verifiable piece of work, and its fields are the specification the developer and the reviewers get; ho_reply talks to the human; ho_steer passes an instruction into a colleague's task in flight; ho_hire adds a lasting colleague; ho_publish pushes a finished branch and opens its pull request. End with ho_report, status done.",
