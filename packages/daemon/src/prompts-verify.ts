...
const PROTOCOL =
  "Protocol: call ho_verify exactly once with verdict pass or fail, one judgement per condition by its number with its fidelity, the task criteria your briefing lists as unverified with their task id, and your screenshots in files, named again on the judgements they back; then stop. You change nothing in this copy, and nothing you change reaches the branch: a fix you want is a finding in your summary.";
